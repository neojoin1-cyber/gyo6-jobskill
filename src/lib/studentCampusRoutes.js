export const STUDENT_CAMPUS_HALLS = [
  ...
  { id: 'ncs-basic', label: 'NCS직업공통능력관', badge: '고졸공채 필기', authority: '고용노동부·한국산업인력공단' },
  { id: 'recruit-written', label: 'NCS직업공통능력 심화관', badge: '고졸공채 필기', authority: '공공기관·금융권·대기업 추가 출제영역' },
