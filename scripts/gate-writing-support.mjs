...
const checks = [
  ...
  ['과목 공통 자율학습 구조', 'src/screens/student/GuidedStudyScreen.jsx', ['StudySummary', 'embeddedHeader', '학습 범위', '단원 선택', '모든 단원 학습 후 종합 진단', '다음 단원 학습', 'program.challengeLabel', "kind: 'summary'"]],
